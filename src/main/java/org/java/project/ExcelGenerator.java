...
public class ExcelGenerator {
    ...
    public void generateHeaderRowOfAttendanceSheet(Workbook workbook, Sheet sheet1, List<String> finalDatesList) {
        ...
        int cellNum = 1;
        for (String finalDay: finalDatesList) {
            Cell headerCell2 = headerRow.createCell(cellNum++);
            headerCell2.setCellValue(finalDay);
    ...
    public void generateNamesInFirstCellsOfAttendanceSheet(Workbook workbook, List<String> participants, Sheet sheet1) {
        int rowNum = 1;
